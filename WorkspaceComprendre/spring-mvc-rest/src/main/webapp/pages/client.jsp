		...
		<div class="panel">
			<header class="panel-heading no-b col-lg-offset-2">
				...
				<div class="panel-body">
					<c:url var="createClient" value="/rest/save" />
					<c:url var="listClient" value="/rest/list" />

					<form:form action="${createClient}" commandName="client"
						method="POST">
						<form:errors path="*" class="alert alert-danger" element="div"></form:errors>
						...
						<div class="pull-right">
							<a href="${listClient}" class="btn btn-default btn-outline">Retour</a>
