				...
				<table class="table table-striped list no-m">
					<tbody>
						<tr>
							<th>Id</th>
							<th>
								<spring:message code="tab.name" text="default text" />
							</th>
							<th>Email</th>
						...
						<c:forEach items="${clients}" var="client">
							<c:url var="urlClientDelete" value="/client/delete.do?id=${client.id}" />
							<c:url var="urlClientUpdate" value="/client/update.do?id=${client.id}" />
							<tr>
